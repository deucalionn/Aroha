...
const portfolioItems = [
    ...
    { id: 2, name: "Solana", symbol: "SOL", value: 440, change: 139, changePercent: 46.37, code: "SOL" },
    { id: 3, name: "Ethereum", symbol: "ETH", value: 573, change: 119, changePercent: 26.25, code: "ETH" },
    { id: 4, name: "RealToken Ecosystem", symbol: "REAL", value: 174, change: 58, changePercent: 50.83, code: "REG" },
    { id: 5, name: "Engie", symbol: "ENGI", value: 325, change: 82, changePercent: 33.74, code: "FR0010208488" },
    { id: 6, name: "McDonald's Corp", symbol: "MCD", value: 282, change: 34, changePercent: 24.98, code: "US5801351017" },
];
...
const PortfolioItemCard = ({ item, chartData }: any) => (
        ...
        <CardContent className="pt-6">
            ...
            <div className="flex justify-between items-end">
                ...
                <div className="text-right">
                    ...
                    <p className="text-emerald-400 text-xs">+{item.changePercent}%</p>
                </div>
            </div>
        </CardContent>
    </Card>
